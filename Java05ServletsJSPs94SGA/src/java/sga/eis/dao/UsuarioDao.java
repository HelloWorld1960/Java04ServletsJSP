 ...
 * encarga de extraer y almacenar informacion de la base de datos. 
 * Esta interfaz contiene los metodos abstractos con las operaciones basicas sobre la tabla de 
   Persona CRUD (Create, Read, Update y Delete). 
