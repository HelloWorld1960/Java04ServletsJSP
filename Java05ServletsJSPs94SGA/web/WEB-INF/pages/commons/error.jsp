<!--Este JSP muestra el Login del sistema.
    Esta directiva hace que el compilador JSP genere la variable de instancia de excepcion. -->
<%@page isErrorPage="true" %>

<!--Scriplet para lanzar el mensaje de error. -->
<%
  ...
  <body onload="ocultarDetalle();">
    <div id="wrap">
      ...
      <div id="nav">
       ...
       <div id="msg">
        <!--Incluir el archivo messages.jsp -->
